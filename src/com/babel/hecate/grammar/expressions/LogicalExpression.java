...
public class LogicalExpression extends HecateExpression {
    ...
    public LogicalExpression(HecateExpression leftExpression, Token operator, HecateExpression rightExpression) {
